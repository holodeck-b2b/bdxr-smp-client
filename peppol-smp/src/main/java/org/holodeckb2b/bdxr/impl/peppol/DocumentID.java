...
/**
 * Represents a <i>Document Identifier</i> as used in the PEPPOL network based on the PEPPOL <i>Policy for use of
 * Identifiers</i>, version 4.0. Policy 2 states that the Document ID must be treated <b>case sensitive</b>. Therefore
...
public class DocumentID extends Identifier {
     ...
     */
    public DocumentID(final String id) {
        super(id, null, true);
    }
     ...
     */
    public DocumentID(final String id, final String scheme) {
